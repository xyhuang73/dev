...
STRATEGY_ID = "DUOYU007317"
STRATEGY_NAME = "多雨定制动量波动率压缩预警策略"
SOURCE_FACTOR_ID = "DUOYU007317"
CATEGORY = "波动率压缩预警"
STYLE = "动量"
OPERATOR_ID = "波动率压缩预警_v6"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    vol_z = _zscore(tr, 19).abs()
    compression = -_cs_rank(vol_z)
    breakout_potential = _breakout(panel, 9)
    raw = compression * 0.35 * VARIANT_WEIGHT + breakout_potential * 0.5 * VARIANT_WEIGHT
    score = _risk_scale(_cs_rank(raw), panel, 11)
    # instance: 波动率压缩预警_v6 | style: 动量 | seed: 20281215
