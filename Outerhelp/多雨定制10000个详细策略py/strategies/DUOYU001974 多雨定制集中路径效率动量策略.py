...
STRATEGY_ID = "DUOYU001974"
STRATEGY_NAME = "多雨定制集中路径效率动量策略"
SOURCE_FACTOR_ID = "DUOYU001974"
CATEGORY = "路径效率动量"
STYLE = "集中"
OPERATOR_ID = "路径效率动量_v5"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    """计算本策略的原始横截面分数。"""
    close = _field(panel, "close")
    eff = _rolling_efficiency_ratio(close, 21)
    raw = 0.41 * VARIANT_WEIGHT * _zscore(eff, 9) + _ret(close, 21)
    score = _risk_scale(_cs_rank(raw), panel, 8)
    # instance: 路径效率动量_v5 | style: 集中 | seed: 20250914
