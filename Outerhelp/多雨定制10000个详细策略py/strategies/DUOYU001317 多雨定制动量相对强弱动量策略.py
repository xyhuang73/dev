...
STRATEGY_ID = "DUOYU001317"
STRATEGY_NAME = "多雨定制动量相对强弱动量策略"
SOURCE_FACTOR_ID = "DUOYU001317"
CATEGORY = "相对强弱动量"
STYLE = "动量"
OPERATOR_ID = "相对强弱动量_v2"
MARKET_SCOPE = "宽基/行业"
HORIZON_DAYS = 16
FAST_WINDOW = 8
SLOW_WINDOW = 16
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = _ret(close, 20) - _ret(index_close, 20) + 0.3 * VARIANT_WEIGHT * _zscore(breadth, 7)
    score = _risk_scale(_cs_rank(raw), panel, 14)
    # instance: 相对强弱动量_v2 | style: 动量 | seed: 20248211
