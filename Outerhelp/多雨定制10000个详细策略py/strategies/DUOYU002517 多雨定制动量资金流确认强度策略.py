...
STRATEGY_ID = "DUOYU002517"
STRATEGY_NAME = "多雨定制动量资金流确认强度策略"
SOURCE_FACTOR_ID = "DUOYU002517"
CATEGORY = "资金流确认强度"
STYLE = "动量"
OPERATOR_ID = "资金流确认强度_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.5 * VARIANT_WEIGHT * _zscore(net_flow, 13) + _ret(close, 24) + 0.21 * VARIANT_WEIGHT * _diff(fund_share, 24)
    score = _risk_scale(_cs_rank(raw), panel, 9)
    # instance: 资金流确认强度_v2 | style: 动量 | seed: 20254211
