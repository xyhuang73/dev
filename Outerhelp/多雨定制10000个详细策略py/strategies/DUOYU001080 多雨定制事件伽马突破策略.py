...
STRATEGY_ID = "DUOYU001080"
STRATEGY_NAME = "多雨定制事件伽马突破策略"
SOURCE_FACTOR_ID = "DUOYU001080"
CATEGORY = "伽马突破"
STYLE = "事件"
OPERATOR_ID = "伽马突破_v10"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    vol_compression = 1.0 - _cs_rank(_zscore(true_range, 18).abs()).abs()
    breakout = _breakout(panel, 4)
    raw = breakout * vol_compression * 1.05 * VARIANT_WEIGHT + 0.18 * VARIANT_WEIGHT * _amount_z(panel, 4)
    score = _risk_scale(_cs_rank(raw), panel, 11)
    # instance: 伽马突破_v10 | style: 事件 | seed: 20246519
