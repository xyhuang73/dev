...
STRATEGY_ID = "DUOYU004130"
STRATEGY_NAME = "多雨定制共振行业资金轮动动量策略"
SOURCE_FACTOR_ID = "DUOYU004130"
CATEGORY = "行业资金轮动动量"
STYLE = "共振"
OPERATOR_ID = "行业资金轮动动量_v7"
MARKET_SCOPE = "行业/主题"
HORIZON_DAYS = 13
FAST_WINDOW = 6
SLOW_WINDOW = 15
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    sector_relative = _cs_rank(_zscore(net_flow, 6)) - _cs_rank(_zscore(net_flow, 15))
    raw = 0.47 * VARIANT_WEIGHT * sector_relative + _ret(close, 6)
    score = _risk_scale(_cs_rank(raw), panel, 13)
    # instance: 行业资金轮动动量_v7 | style: 共振 | seed: 20261516
