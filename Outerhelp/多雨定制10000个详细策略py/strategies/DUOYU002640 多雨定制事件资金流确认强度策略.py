...
STRATEGY_ID = "DUOYU002640"
STRATEGY_NAME = "多雨定制事件资金流确认强度策略"
SOURCE_FACTOR_ID = "DUOYU002640"
CATEGORY = "资金流确认强度"
STYLE = "事件"
OPERATOR_ID = "资金流确认强度_v8"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.52 * VARIANT_WEIGHT * _zscore(net_flow, 8) + _ret(close, 21) + 0.16 * VARIANT_WEIGHT * _diff(fund_share, 21)
    score = _risk_scale(_cs_rank(raw), panel, 16)
    # instance: 资金流确认强度_v8 | style: 事件 | seed: 20254517
