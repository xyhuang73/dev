...
STRATEGY_ID = "DUOYU007610"
STRATEGY_NAME = "多雨定制共振解禁到期压力策略"
SOURCE_FACTOR_ID = "DUOYU007610"
CATEGORY = "解禁到期压力"
STYLE = "共振"
OPERATOR_ID = "解禁到期压力_v6"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    pressure = _lockup_pressure(lockup_ratio, lockup_days, 10)
    raw = -0.46 * VARIANT_WEIGHT * _zscore(pressure, 12) + _ret(close, 19)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 解禁到期压力_v6 | style: 共振 | seed: 20282515
