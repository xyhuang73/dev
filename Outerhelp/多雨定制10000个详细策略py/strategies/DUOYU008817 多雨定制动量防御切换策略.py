...
STRATEGY_ID = "DUOYU008817"
STRATEGY_NAME = "多雨定制动量防御切换策略"
SOURCE_FACTOR_ID = "DUOYU008817"
CATEGORY = "防御切换"
STYLE = "动量"
OPERATOR_ID = "防御切换_v3"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = -_zscore(appetite, 7) + 0.33 * VARIANT_WEIGHT * _zscore(dividend, 16) - _downside_vol(close, 16) - 0.26 * VARIANT_WEIGHT * _zscore(downside, 16).abs()
    score = _cs_rank(raw)
    # instance: 防御切换_v3 | style: 动量 | seed: 20292212
