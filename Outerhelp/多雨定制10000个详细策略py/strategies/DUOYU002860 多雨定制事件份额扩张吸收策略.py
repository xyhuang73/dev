...
STRATEGY_ID = "DUOYU002860"
STRATEGY_NAME = "多雨定制事件份额扩张吸收策略"
SOURCE_FACTOR_ID = "DUOYU002860"
CATEGORY = "份额扩张吸收"
STYLE = "事件"
OPERATOR_ID = "份额扩张吸收_v9"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = _diff(fund_share, 24) * resilience + 0.3 * VARIANT_WEIGHT * _amount_z(panel, 24)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 份额扩张吸收_v9 | style: 事件 | seed: 20255518
