...
STRATEGY_ID = "DUOYU004217"
STRATEGY_NAME = "多雨定制动量申赎套利流策略"
SOURCE_FACTOR_ID = "DUOYU004217"
CATEGORY = "申赎套利流"
STYLE = "动量"
OPERATOR_ID = "申赎套利流_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    arb_flow = -_zscore(premium, 9) * _zscore(_ret(nav, 24), 9)
    raw = 0.41 * VARIANT_WEIGHT * arb_flow + _ret(close, 24)
    score = _risk_scale(_cs_rank(raw), panel, 15)
    # instance: 申赎套利流_v2 | style: 动量 | seed: 20263211
