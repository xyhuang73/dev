...
STRATEGY_ID = "DUOYU000467"
STRATEGY_NAME = "多雨定制加速缺口回补修复策略"
SOURCE_FACTOR_ID = "DUOYU000467"
CATEGORY = "缺口回补修复"
STYLE = "加速"
OPERATOR_ID = "缺口回补修复_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    trend = _ret(close, 20)
    raw = gap_fill * _sigmoid_gate(trend, 0, 3) + 0.11 * VARIANT_WEIGHT * _amount_z(panel, 6)
    score = _risk_scale(_cs_rank(raw), panel, 8)
    # instance: 缺口回补修复_v2 | style: 加速 | seed: 20243211
