...
STRATEGY_ID = "DUOYU001757"
STRATEGY_NAME = "多雨定制动量横截面动量差异策略"
SOURCE_FACTOR_ID = "DUOYU001757"
CATEGORY = "横截面动量差异"
STYLE = "动量"
OPERATOR_ID = "横截面动量差异_v4"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.3 * VARIANT_WEIGHT * _zscore(momentum_diff, 8) + _ret(close, 16)
    score = _risk_scale(_cs_rank(raw), panel, 9)
    # instance: 横截面动量差异_v4 | style: 动量 | seed: 20250213
