...
STRATEGY_ID = "DUOYU000690"
STRATEGY_NAME = "多雨定制共振成交量剖面支撑策略"
SOURCE_FACTOR_ID = "DUOYU000690"
CATEGORY = "成交量剖面支撑"
STYLE = "共振"
OPERATOR_ID = "成交量剖面支撑_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.47 * VARIANT_WEIGHT * _zscore(vol_support, 9) + _ret(close, 25) + 0.15 * VARIANT_WEIGHT * _amount_z(panel, 9)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 成交量剖面支撑_v2 | style: 共振 | seed: 20244511
