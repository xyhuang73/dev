...
STRATEGY_ID = "DUOYU000917"
STRATEGY_NAME = "多雨定制动量伽马突破策略"
SOURCE_FACTOR_ID = "DUOYU000917"
CATEGORY = "伽马突破"
STYLE = "动量"
OPERATOR_ID = "伽马突破_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    vol_compression = 1.0 - _cs_rank(_zscore(true_range, 14).abs()).abs()
    breakout = _breakout(panel, 4)
    raw = breakout * vol_compression * 0.95 * VARIANT_WEIGHT + 0.11 * VARIANT_WEIGHT * _amount_z(panel, 4)
    score = _risk_scale(_cs_rank(raw), panel, 14)
    # instance: 伽马突破_v2 | style: 动量 | seed: 20246211
