...
STRATEGY_ID = "DUOYU005809"
STRATEGY_NAME = "多雨定制反转已实现波动率状态切换策略"
SOURCE_FACTOR_ID = "DUOYU005809"
CATEGORY = "已实现波动率状态切换"
STYLE = "反转"
OPERATOR_ID = "已实现波动率状态切换_v3"
...
"""
DUOYU005809 - 多雨定制反转已实现波动率状态切换策略
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = np.where(vol_regime > 0, trend_term + 0.21 * VARIANT_WEIGHT * _amount_z(panel, 6),
                   rev_term + 0.21 * VARIANT_WEIGHT * _amount_z(panel, 6))
    score = _risk_scale(_cs_rank(raw), panel, 12)
    # instance: 已实现波动率状态切换_v3 | style: 反转 | seed: 20271412
