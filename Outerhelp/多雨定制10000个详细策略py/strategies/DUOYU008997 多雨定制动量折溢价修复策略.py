...
STRATEGY_ID = "DUOYU008997"
STRATEGY_NAME = "多雨定制动量折溢价修复策略"
SOURCE_FACTOR_ID = "DUOYU008997"
CATEGORY = "折溢价修复"
STYLE = "动量"
OPERATOR_ID = "折溢价修复_v5"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = -_zscore(premium, 22) + 0.3 * VARIANT_WEIGHT * _ret(nav, 22) + 0.14 * VARIANT_WEIGHT * _ret(close, 12)
    score = _risk_scale(_cs_rank(raw), panel, 12)
    # instance: 折溢价修复_v5 | style: 动量 | seed: 20293214
