...
STRATEGY_ID = "DUOYU007340"
STRATEGY_NAME = "多雨定制事件波动率压缩预警策略"
SOURCE_FACTOR_ID = "DUOYU007340"
CATEGORY = "波动率压缩预警"
STYLE = "事件"
OPERATOR_ID = "波动率压缩预警_v7"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    breakout_potential = _breakout(panel, 6)
    raw = compression * 0.44 * VARIANT_WEIGHT + breakout_potential * 0.49 * VARIANT_WEIGHT
    score = _risk_scale(_cs_rank(raw), panel, 5)
    # instance: 波动率压缩预警_v7 | style: 事件 | seed: 20281516
