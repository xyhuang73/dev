...
STRATEGY_ID = "DUOYU004649"
STRATEGY_NAME = "多雨定制反转买卖盘深度失衡策略"
SOURCE_FACTOR_ID = "DUOYU004649"
CATEGORY = "买卖盘深度失衡"
STYLE = "反转"
OPERATOR_ID = "买卖盘深度失衡_v6"
MARKET_SCOPE = "流动性较好"
HORIZON_DAYS = 17
FAST_WINDOW = 5
SLOW_WINDOW = 23
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    depth_imbalance = (_zscore(turnover, 5) - _zscore(spread, 5).abs()) / (1.0 + _zscore(spread, 26).abs())
    raw = 0.45 * VARIANT_WEIGHT * _zscore(depth_imbalance, 5) + _ret(close, 26)
    score = _risk_scale(_cs_rank(raw), panel, 16)
    # instance: 买卖盘深度失衡_v6 | style: 反转 | seed: 20264415
