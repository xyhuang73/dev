...
STRATEGY_ID = "DUOYU008260"
STRATEGY_NAME = "多雨定制事件业绩超预期动量策略"
SOURCE_FACTOR_ID = "DUOYU008260"
CATEGORY = "业绩超预期动量"
STYLE = "事件"
OPERATOR_ID = "业绩超预期动量_v3"
MARKET_SCOPE = "行业/主题"
HORIZON_DAYS = 10
FAST_WINDOW = 6
SLOW_WINDOW = 14
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    surprise = _zscore(earnings_revision, 6) - _zscore(earnings_revision, 16)
    raw = 0.38 * VARIANT_WEIGHT * surprise + 0.32 * VARIANT_WEIGHT * _ret(industry_momentum, 6) + _ret(close, 6)
    raw = raw * _sigmoid_gate(surprise, 0, 4)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 业绩超预期动量_v3 | style: 事件 | seed: 20288512
