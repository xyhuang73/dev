...
STRATEGY_ID = "DUOYU002430"
STRATEGY_NAME = "多雨定制共振日内积累分布策略"
SOURCE_FACTOR_ID = "DUOYU002430"
CATEGORY = "日内积累分布"
STYLE = "共振"
OPERATOR_ID = "日内积累分布_v8"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    """计算本策略的原始横截面分数。"""
    raw = _close_location(panel) + 0.3 * VARIANT_WEIGHT * _vwap_support(panel, 8) + 0.2 * VARIANT_WEIGHT * _amount_z(panel, 8)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 日内积累分布_v8 | style: 共振 | seed: 20252517
