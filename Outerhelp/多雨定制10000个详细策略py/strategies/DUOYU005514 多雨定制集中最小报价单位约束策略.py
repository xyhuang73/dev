...
STRATEGY_ID = "DUOYU005514"
STRATEGY_NAME = "多雨定制集中最小报价单位约束策略"
SOURCE_FACTOR_ID = "DUOYU005514"
CATEGORY = "最小报价单位约束"
STYLE = "集中"
OPERATOR_ID = "最小报价单位约束_v4"
MARKET_SCOPE = "全市场"
HORIZON_DAYS = 10
FAST_WINDOW = 8
SLOW_WINDOW = 16
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = -0.28 * VARIANT_WEIGHT * _zscore(tick_constraint, 21) + 0.26 * VARIANT_WEIGHT * _amount_z(panel, 7)
    score = _risk_scale(_cs_rank(raw), panel, 8)
    # instance: 最小报价单位约束_v4 | style: 集中 | seed: 20269913
