...
STRATEGY_ID = "DUOYU007400"
STRATEGY_NAME = "多雨定制事件政策事件评分策略"
SOURCE_FACTOR_ID = "DUOYU007400"
CATEGORY = "政策事件评分"
STYLE = "事件"
OPERATOR_ID = "政策事件评分_v2"
MARKET_SCOPE = "行业/主题"
HORIZON_DAYS = 14
FAST_WINDOW = 6
SLOW_WINDOW = 25
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = _zscore(policy, 6) * _event_proximity(distance, 13) + 0.24 * VARIANT_WEIGHT * _amount_z(panel, 6)
    score = _risk_scale(_cs_rank(raw), panel, 13)
    # instance: 政策事件评分_v2 | style: 事件 | seed: 20282511
