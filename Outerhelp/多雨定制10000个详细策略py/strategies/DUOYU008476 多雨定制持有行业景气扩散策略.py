...
STRATEGY_ID = "DUOYU008476"
STRATEGY_NAME = "多雨定制持有行业景气扩散策略"
SOURCE_FACTOR_ID = "DUOYU008476"
CATEGORY = "行业景气扩散"
STYLE = "持有"
OPERATOR_ID = "行业景气扩散_v7"
MARKET_SCOPE = "行业/主题"
HORIZON_DAYS = 4
FAST_WINDOW = 4
SLOW_WINDOW = 35
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.43 * VARIANT_WEIGHT * _zscore(prosperity, 26) + 0.41 * VARIANT_WEIGHT * _zscore(revision, 26) + _ret(industry_momentum, 6)
    score = _risk_scale(_cs_rank(raw), panel, 7)
    # instance: 行业景气扩散_v7 | style: 持有 | seed: 20289116
