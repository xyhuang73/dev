...
STRATEGY_ID = "DUOYU008900"
STRATEGY_NAME = "多雨定制事件防御切换策略"
SOURCE_FACTOR_ID = "DUOYU008900"
CATEGORY = "防御切换"
STYLE = "事件"
OPERATOR_ID = "防御切换_v7"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = -_zscore(appetite, 8) + 0.33 * VARIANT_WEIGHT * _zscore(dividend, 14) - _downside_vol(close, 14) - 0.26 * VARIANT_WEIGHT * _zscore(downside, 14).abs()
    score = _cs_rank(raw)
    # instance: 防御切换_v7 | style: 事件 | seed: 20292516
