...
STRATEGY_ID = "DUOYU007577"
STRATEGY_NAME = "多雨定制动量解禁到期压力策略"
SOURCE_FACTOR_ID = "DUOYU007577"
CATEGORY = "解禁到期压力"
STYLE = "动量"
OPERATOR_ID = "解禁到期压力_v4"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    pressure = _lockup_pressure(lockup_ratio, lockup_days, 16)
    raw = -0.33 * VARIANT_WEIGHT * _zscore(pressure, 13) + _ret(close, 16)
    score = _risk_scale(_cs_rank(raw), panel, 14)
    # instance: 解禁到期压力_v4 | style: 动量 | seed: 20283213
