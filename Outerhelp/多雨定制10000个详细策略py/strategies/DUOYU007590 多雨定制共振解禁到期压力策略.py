...
STRATEGY_ID = "DUOYU007590"
STRATEGY_NAME = "多雨定制共振解禁到期压力策略"
SOURCE_FACTOR_ID = "DUOYU007590"
CATEGORY = "解禁到期压力"
STYLE = "共振"
OPERATOR_ID = "解禁到期压力_v5"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    pressure = _lockup_pressure(lockup_ratio, lockup_days, 15)
    raw = -0.42 * VARIANT_WEIGHT * _zscore(pressure, 6) + _ret(close, 22)
    raw = raw * _max_dd_guard(drawdown, -0.12)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 解禁到期压力_v5 | style: 共振 | seed: 20282514
