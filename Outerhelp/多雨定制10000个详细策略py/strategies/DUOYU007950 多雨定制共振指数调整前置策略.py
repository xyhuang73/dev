...
STRATEGY_ID = "DUOYU007950"
STRATEGY_NAME = "多雨定制共振指数调整前置策略"
SOURCE_FACTOR_ID = "DUOYU007950"
CATEGORY = "指数调整前置"
STYLE = "共振"
OPERATOR_ID = "指数调整前置_v2"
MARKET_SCOPE = "宽基/行业"
HORIZON_DAYS = 12
FAST_WINDOW = 9
SLOW_WINDOW = 15
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    frontrun_score = _event_proximity(rebalance_dist, 12) * _amount_z(panel, 9)
    raw = 0.32 * VARIANT_WEIGHT * _zscore(frontrun_score, 9) + _ret(close, 15)
    score = _risk_scale(_cs_rank(raw), panel, 12)
    # instance: 指数调整前置_v2 | style: 共振 | seed: 20285511
