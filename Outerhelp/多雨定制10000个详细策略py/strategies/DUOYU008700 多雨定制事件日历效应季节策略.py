...
STRATEGY_ID = "DUOYU008700"
STRATEGY_NAME = "多雨定制事件日历效应季节策略"
SOURCE_FACTOR_ID = "DUOYU008700"
CATEGORY = "日历效应季节"
STYLE = "事件"
OPERATOR_ID = "日历效应季节_v4"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.43 * VARIANT_WEIGHT * _zscore(seasonality, 27) + _event_proximity(distance, 15) + 0.19 * VARIANT_WEIGHT * _amount_z(panel, 8)
    score = _risk_scale(_cs_rank(raw), panel, 15)
    # instance: 日历效应季节_v4 | style: 事件 | seed: 20291513
