...
STRATEGY_ID = "DUOYU005657"
STRATEGY_NAME = "多雨定制动量跟踪质量策略"
SOURCE_FACTOR_ID = "DUOYU005657"
CATEGORY = "跟踪质量"
STYLE = "动量"
OPERATOR_ID = "跟踪质量_v3"
MARKET_SCOPE = "宽基/行业"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = _ret(index_close, 25) - 0.41 * VARIANT_WEIGHT * _zscore(tracking_error, 25).abs() - 0.2 * VARIANT_WEIGHT * _zscore(tracking_diff, 25).abs()
    score = _risk_scale(_cs_rank(raw), panel, 12)
    # instance: 跟踪质量_v3 | style: 动量 | seed: 20271212
