...
STRATEGY_ID = "DUOYU001776"
STRATEGY_NAME = "多雨定制持有横截面动量差异策略"
SOURCE_FACTOR_ID = "DUOYU001776"
CATEGORY = "横截面动量差异"
STYLE = "持有"
OPERATOR_ID = "横截面动量差异_v5"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.31 * VARIANT_WEIGHT * _zscore(momentum_diff, 10) + _ret(close, 25)
    raw = raw * _sigmoid_gate(_ret(close, 10), 0, 3)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 横截面动量差异_v5 | style: 持有 | seed: 20250114
