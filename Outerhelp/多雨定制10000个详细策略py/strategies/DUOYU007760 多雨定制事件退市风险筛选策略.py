...
STRATEGY_ID = "DUOYU007760"
STRATEGY_NAME = "多雨定制事件退市风险筛选策略"
SOURCE_FACTOR_ID = "DUOYU007760"
CATEGORY = "退市风险筛选"
STYLE = "事件"
OPERATOR_ID = "退市风险筛选_v6"
MARKET_SCOPE = "全市场"
HORIZON_DAYS = 12
FAST_WINDOW = 12
SLOW_WINDOW = 20
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    st_flag = _field(panel, "st_risk_flag") if "st_risk_flag" in panel.columns else _zscore(delist_score, 22)
    ...
    raw = 0.42 * VARIANT_WEIGHT * _zscore(risk_dist, 12) + 0.18 * VARIANT_WEIGHT * _zscore(audit, 22) + _ret(close, 22)
    score = _risk_scale(_cs_rank(raw), panel, 12)
    # instance: 退市风险筛选_v6 | style: 事件 | seed: 20284515
