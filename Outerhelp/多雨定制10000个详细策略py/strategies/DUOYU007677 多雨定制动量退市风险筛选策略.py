...
STRATEGY_ID = "DUOYU007677"
STRATEGY_NAME = "多雨定制动量退市风险筛选策略"
SOURCE_FACTOR_ID = "DUOYU007677"
CATEGORY = "退市风险筛选"
STYLE = "动量"
OPERATOR_ID = "退市风险筛选_v2"
MARKET_SCOPE = "全市场"
HORIZON_DAYS = 14
FAST_WINDOW = 17
SLOW_WINDOW = 24
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    st_flag = _field(panel, "st_risk_flag") if "st_risk_flag" in panel.columns else _zscore(delist_score, 29)
    ...
    raw = 0.39 * VARIANT_WEIGHT * _zscore(risk_dist, 15) + 0.19 * VARIANT_WEIGHT * _zscore(audit, 29) + _ret(close, 29)
    score = _risk_scale(_cs_rank(raw), panel, 12)
    # instance: 退市风险筛选_v2 | style: 动量 | seed: 20284211
