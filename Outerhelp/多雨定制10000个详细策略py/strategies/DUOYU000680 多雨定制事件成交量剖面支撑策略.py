...
STRATEGY_ID = "DUOYU000680"
STRATEGY_NAME = "多雨定制事件成交量剖面支撑策略"
SOURCE_FACTOR_ID = "DUOYU000680"
CATEGORY = "成交量剖面支撑"
STYLE = "事件"
OPERATOR_ID = "成交量剖面支撑_v1"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.4 * VARIANT_WEIGHT * _zscore(vol_support, 9) + _ret(close, 15) + 0.19 * VARIANT_WEIGHT * _amount_z(panel, 9)
    score = _risk_scale(_cs_rank(raw), panel, 14)
    # instance: 成交量剖面支撑_v1 | style: 事件 | seed: 20245510
