...
STRATEGY_ID = "DUOYU005349"
STRATEGY_NAME = "多雨定制反转委托簿斜率策略"
SOURCE_FACTOR_ID = "DUOYU005349"
CATEGORY = "委托簿斜率"
STYLE = "反转"
OPERATOR_ID = "委托簿斜率_v5"
MARKET_SCOPE = "流动性较好"
HORIZON_DAYS = 13
FAST_WINDOW = 7
SLOW_WINDOW = 22
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    book_slope = _zscore(spread, 7) / (_zscore(turnover, 7).abs() + EPS)
    raw = -0.25 * VARIANT_WEIGHT * _zscore(book_slope, 7) + _ret(close, 25)
    score = _risk_scale(_cs_rank(raw), panel, 12)
    # instance: 委托簿斜率_v5 | style: 反转 | seed: 20268414
