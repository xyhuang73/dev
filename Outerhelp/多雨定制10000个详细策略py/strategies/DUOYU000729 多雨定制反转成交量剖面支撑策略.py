...
STRATEGY_ID = "DUOYU000729"
STRATEGY_NAME = "多雨定制反转成交量剖面支撑策略"
SOURCE_FACTOR_ID = "DUOYU000729"
CATEGORY = "成交量剖面支撑"
STYLE = "反转"
OPERATOR_ID = "成交量剖面支撑_v4"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.28 * VARIANT_WEIGHT * _zscore(vol_support, 8) + _ret(close, 15) + 0.17 * VARIANT_WEIGHT * _amount_z(panel, 8)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 成交量剖面支撑_v4 | style: 反转 | seed: 20244413
