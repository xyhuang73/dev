...
STRATEGY_ID = "DUOYU008617"
STRATEGY_NAME = "多雨定制动量成份广度扩散策略"
SOURCE_FACTOR_ID = "DUOYU008617"
CATEGORY = "成份广度扩散"
STYLE = "动量"
OPERATOR_ID = "成份广度扩散_v7"
MARKET_SCOPE = "宽基/行业"
HORIZON_DAYS = 20
FAST_WINDOW = 9
SLOW_WINDOW = 22
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.48 * VARIANT_WEIGHT * _zscore(up_ratio, 8) + 0.29 * VARIANT_WEIGHT * _zscore(new_high_ratio, 27) - _zscore(dispersion, 27).abs()
    score = _risk_scale(_cs_rank(raw), panel, 17)
    # instance: 成份广度扩散_v7 | style: 动量 | seed: 20290216
