...
STRATEGY_ID = "DUOYU004509"
STRATEGY_NAME = "多雨定制反转多维流动性承载策略"
SOURCE_FACTOR_ID = "DUOYU004509"
CATEGORY = "多维流动性承载"
STYLE = "反转"
OPERATOR_ID = "多维流动性承载_v8"
MARKET_SCOPE = "流动性较好"
HORIZON_DAYS = 14
FAST_WINDOW = 7
SLOW_WINDOW = 25
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.49 * VARIANT_WEIGHT * _amount_z(panel, 28) + 0.31 * VARIANT_WEIGHT * _zscore(turnover, 7) - _zscore(spread, 7).abs()
    score = _cs_rank(raw)
    # instance: 多维流动性承载_v8 | style: 反转 | seed: 20263417
