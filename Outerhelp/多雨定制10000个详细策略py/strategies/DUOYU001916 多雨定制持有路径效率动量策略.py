...
STRATEGY_ID = "DUOYU001916"
STRATEGY_NAME = "多雨定制持有路径效率动量策略"
SOURCE_FACTOR_ID = "DUOYU001916"
CATEGORY = "路径效率动量"
STYLE = "持有"
OPERATOR_ID = "路径效率动量_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    """计算本策略的原始横截面分数。"""
    close = _field(panel, "close")
    eff = _rolling_efficiency_ratio(close, 28)
    raw = 0.51 * VARIANT_WEIGHT * _zscore(eff, 13) + _ret(close, 28)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 路径效率动量_v2 | style: 持有 | seed: 20251111
