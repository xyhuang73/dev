...
STRATEGY_ID = "DUOYU005237"
STRATEGY_NAME = "多雨定制动量自由流通调整承载策略"
SOURCE_FACTOR_ID = "DUOYU005237"
CATEGORY = "自由流通调整承载"
STYLE = "动量"
OPERATOR_ID = "自由流通调整承载_v8"
MARKET_SCOPE = "全市场"
HORIZON_DAYS = 8
FAST_WINDOW = 9
SLOW_WINDOW = 18
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.33 * VARIANT_WEIGHT * _zscore(free_float_adj, 8) + 0.17 * VARIANT_WEIGHT * _amount_z(panel, 8)
    score = _risk_scale(_cs_rank(raw), panel, 7)
    # instance: 自由流通调整承载_v8 | style: 动量 | seed: 20268217
