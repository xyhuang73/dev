...
STRATEGY_ID = "DUOYU000994"
STRATEGY_NAME = "多雨定制集中伽马突破策略"
SOURCE_FACTOR_ID = "DUOYU000994"
CATEGORY = "伽马突破"
STYLE = "集中"
OPERATOR_ID = "伽马突破_v6"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    vol_compression = 1.0 - _cs_rank(_zscore(true_range, 25).abs()).abs()
    breakout = _breakout(panel, 10)
    raw = breakout * vol_compression * 0.71 * VARIANT_WEIGHT + 0.19 * VARIANT_WEIGHT * _amount_z(panel, 10)
    score = _risk_scale(_cs_rank(raw), panel, 8)
    # instance: 伽马突破_v6 | style: 集中 | seed: 20245915
