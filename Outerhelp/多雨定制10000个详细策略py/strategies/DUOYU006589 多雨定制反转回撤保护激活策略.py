...
STRATEGY_ID = "DUOYU006589"
STRATEGY_NAME = "多雨定制反转回撤保护激活策略"
SOURCE_FACTOR_ID = "DUOYU006589"
CATEGORY = "回撤保护激活"
STYLE = "反转"
OPERATOR_ID = "回撤保护激活_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = -_zscore(drawdown, 28) * dd_guard + 0.41 * VARIANT_WEIGHT * _zscore(net_flow, 9) + _repair_slope(close, 9)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 回撤保护激活_v2 | style: 反转 | seed: 20276411
