...
STRATEGY_ID = "DUOYU002957"
STRATEGY_NAME = "多雨定制动量拥挤度退潮策略"
SOURCE_FACTOR_ID = "DUOYU002957"
CATEGORY = "拥挤度退潮"
STYLE = "动量"
OPERATOR_ID = "拥挤度退潮_v4"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    weakening = (_ret(close, 7) < 0).astype(float)
    raw = -_zscore(attention, 7) * weakening - 0.35 * VARIANT_WEIGHT * _zscore(turnover, 7)
    score = _risk_scale(_cs_rank(raw), panel, 14)
    # instance: 拥挤度退潮_v4 | style: 动量 | seed: 20256213
