...
STRATEGY_ID = "DUOYU005737"
STRATEGY_NAME = "多雨定制动量跟踪质量策略"
SOURCE_FACTOR_ID = "DUOYU005737"
CATEGORY = "跟踪质量"
STYLE = "动量"
OPERATOR_ID = "跟踪质量_v7"
MARKET_SCOPE = "宽基/行业"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = _ret(index_close, 20) - 0.5 * VARIANT_WEIGHT * _zscore(tracking_error, 20).abs() - 0.32 * VARIANT_WEIGHT * _zscore(tracking_diff, 20).abs()
    score = _risk_scale(_cs_rank(raw), panel, 11)
    # instance: 跟踪质量_v7 | style: 动量 | seed: 20271216
