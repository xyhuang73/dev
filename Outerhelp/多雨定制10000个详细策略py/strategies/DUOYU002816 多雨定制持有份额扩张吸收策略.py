...
STRATEGY_ID = "DUOYU002816"
STRATEGY_NAME = "多雨定制持有份额扩张吸收策略"
SOURCE_FACTOR_ID = "DUOYU002816"
CATEGORY = "份额扩张吸收"
STYLE = "持有"
OPERATOR_ID = "份额扩张吸收_v7"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = _diff(fund_share, 14) * resilience + 0.19 * VARIANT_WEIGHT * _amount_z(panel, 14)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 份额扩张吸收_v7 | style: 持有 | seed: 20255116
