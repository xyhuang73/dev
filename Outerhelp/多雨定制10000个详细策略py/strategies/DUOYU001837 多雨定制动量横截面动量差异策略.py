...
STRATEGY_ID = "DUOYU001837"
STRATEGY_NAME = "多雨定制动量横截面动量差异策略"
SOURCE_FACTOR_ID = "DUOYU001837"
CATEGORY = "横截面动量差异"
STYLE = "动量"
OPERATOR_ID = "横截面动量差异_v8"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.32 * VARIANT_WEIGHT * _zscore(momentum_diff, 7) + _ret(close, 18)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 横截面动量差异_v8 | style: 动量 | seed: 20250217
