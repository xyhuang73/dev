...
STRATEGY_ID = "DUOYU002876"
STRATEGY_NAME = "多雨定制持有份额扩张吸收策略"
SOURCE_FACTOR_ID = "DUOYU002876"
CATEGORY = "份额扩张吸收"
STYLE = "持有"
OPERATOR_ID = "份额扩张吸收_v10"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    resilience = _ret(close, 9) - _downside_vol(close, 9)
    raw = _diff(fund_share, 26) * resilience + 0.27 * VARIANT_WEIGHT * _amount_z(panel, 26)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 份额扩张吸收_v10 | style: 持有 | seed: 20255119
