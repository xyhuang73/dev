...
STRATEGY_ID = "DUOYU007030"
STRATEGY_NAME = "多雨定制共振最大回撤守护策略"
SOURCE_FACTOR_ID = "DUOYU007030"
CATEGORY = "最大回撤守护"
STYLE = "共振"
OPERATOR_ID = "最大回撤守护_v8"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = _ret(close, 25) * _max_dd_guard(drawdown, -0.12) + 0.25 * VARIANT_WEIGHT * dd_score
    score = _risk_scale(_cs_rank(raw), panel, 15)
    # instance: 最大回撤守护_v8 | style: 共振 | seed: 20278517
