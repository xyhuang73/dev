...
STRATEGY_ID = "DUOYU009310"
STRATEGY_NAME = "多雨定制共振商品联动对冲策略"
SOURCE_FACTOR_ID = "DUOYU009310"
CATEGORY = "商品联动对冲"
STYLE = "共振"
OPERATOR_ID = "商品联动对冲_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    commodity_link = _zscore(lead_asset, 9) * _ret(close, 9)
    raw = 0.27 * VARIANT_WEIGHT * commodity_link + _ret(close, 20)
    score = _risk_scale(_cs_rank(raw), panel, 16)
    # instance: 商品联动对冲_v2 | style: 共振 | seed: 20295511
