...
STRATEGY_ID = "DUOYU000716"
STRATEGY_NAME = "多雨定制持有成交量剖面支撑策略"
SOURCE_FACTOR_ID = "DUOYU000716"
CATEGORY = "成交量剖面支撑"
STYLE = "持有"
OPERATOR_ID = "成交量剖面支撑_v3"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.43 * VARIANT_WEIGHT * _zscore(vol_support, 10) + _ret(close, 14) + 0.12 * VARIANT_WEIGHT * _amount_z(panel, 10)
    score = _risk_scale(_cs_rank(raw), panel, 16)
    # instance: 成交量剖面支撑_v3 | style: 持有 | seed: 20245112
