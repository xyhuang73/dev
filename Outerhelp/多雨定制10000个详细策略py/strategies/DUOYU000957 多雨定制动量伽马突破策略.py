...
STRATEGY_ID = "DUOYU000957"
STRATEGY_NAME = "多雨定制动量伽马突破策略"
SOURCE_FACTOR_ID = "DUOYU000957"
CATEGORY = "伽马突破"
STYLE = "动量"
OPERATOR_ID = "伽马突破_v4"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    vol_compression = 1.0 - _cs_rank(_zscore(true_range, 23).abs()).abs()
    breakout = _breakout(panel, 7)
    raw = breakout * vol_compression * 0.92 * VARIANT_WEIGHT + 0.11 * VARIANT_WEIGHT * _amount_z(panel, 7)
    score = _risk_scale(_cs_rank(raw), panel, 9)
    # instance: 伽马突破_v4 | style: 动量 | seed: 20246213
