...
STRATEGY_ID = "DUOYU001716"
STRATEGY_NAME = "多雨定制持有横截面动量差异策略"
SOURCE_FACTOR_ID = "DUOYU001716"
CATEGORY = "横截面动量差异"
STYLE = "持有"
OPERATOR_ID = "横截面动量差异_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.41 * VARIANT_WEIGHT * _zscore(momentum_diff, 9) + _ret(close, 25)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 横截面动量差异_v2 | style: 持有 | seed: 20250111
