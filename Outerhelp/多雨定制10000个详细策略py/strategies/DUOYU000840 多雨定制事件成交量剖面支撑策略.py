...
STRATEGY_ID = "DUOYU000840"
STRATEGY_NAME = "多雨定制事件成交量剖面支撑策略"
SOURCE_FACTOR_ID = "DUOYU000840"
CATEGORY = "成交量剖面支撑"
STYLE = "事件"
OPERATOR_ID = "成交量剖面支撑_v9"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.4 * VARIANT_WEIGHT * _zscore(vol_support, 6) + _ret(close, 20) + 0.14 * VARIANT_WEIGHT * _amount_z(panel, 6)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 成交量剖面支撑_v9 | style: 事件 | seed: 20245518
