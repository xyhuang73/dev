...
STRATEGY_ID = "DUOYU008240"
STRATEGY_NAME = "多雨定制事件业绩超预期动量策略"
SOURCE_FACTOR_ID = "DUOYU008240"
CATEGORY = "业绩超预期动量"
STYLE = "事件"
OPERATOR_ID = "业绩超预期动量_v2"
MARKET_SCOPE = "行业/主题"
HORIZON_DAYS = 14
FAST_WINDOW = 6
SLOW_WINDOW = 25
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    surprise = _zscore(earnings_revision, 6) - _zscore(earnings_revision, 28)
    raw = 0.43 * VARIANT_WEIGHT * surprise + 0.22 * VARIANT_WEIGHT * _ret(industry_momentum, 6) + _ret(close, 6)
    score = _risk_scale(_cs_rank(raw), panel, 13)
    # instance: 业绩超预期动量_v2 | style: 事件 | seed: 20288511
