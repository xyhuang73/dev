...
STRATEGY_ID = "DUOYU004249"
STRATEGY_NAME = "多雨定制反转申赎套利流策略"
SOURCE_FACTOR_ID = "DUOYU004249"
CATEGORY = "申赎套利流"
STYLE = "反转"
OPERATOR_ID = "申赎套利流_v4"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    arb_flow = -_zscore(premium, 6) * _zscore(_ret(nav, 23), 6)
    raw = 0.33 * VARIANT_WEIGHT * arb_flow + _ret(close, 23)
    score = _risk_scale(_cs_rank(raw), panel, 11)
    # instance: 申赎套利流_v4 | style: 反转 | seed: 20262413
