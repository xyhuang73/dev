...
STRATEGY_ID = "DUOYU000557"
STRATEGY_NAME = "多雨定制动量缺口回补修复策略"
SOURCE_FACTOR_ID = "DUOYU000557"
CATEGORY = "缺口回补修复"
STYLE = "动量"
OPERATOR_ID = "缺口回补修复_v6"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    trend = _ret(close, 22)
    raw = gap_fill * _sigmoid_gate(trend, 0, 3) + 0.15 * VARIANT_WEIGHT * _amount_z(panel, 12)
    score = _risk_scale(_cs_rank(raw), panel, 13)
    # instance: 缺口回补修复_v6 | style: 动量 | seed: 20244215
