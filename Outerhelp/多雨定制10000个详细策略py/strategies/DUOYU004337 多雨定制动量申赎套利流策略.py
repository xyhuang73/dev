...
STRATEGY_ID = "DUOYU004337"
STRATEGY_NAME = "多雨定制动量申赎套利流策略"
SOURCE_FACTOR_ID = "DUOYU004337"
CATEGORY = "申赎套利流"
STYLE = "动量"
OPERATOR_ID = "申赎套利流_v8"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    arb_flow = -_zscore(premium, 5) * _zscore(_ret(nav, 14), 5)
    raw = 0.3 * VARIANT_WEIGHT * arb_flow + _ret(close, 14)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 申赎套利流_v8 | style: 动量 | seed: 20263217
