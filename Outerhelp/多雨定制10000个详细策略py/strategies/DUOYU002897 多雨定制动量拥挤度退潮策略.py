...
STRATEGY_ID = "DUOYU002897"
STRATEGY_NAME = "多雨定制动量拥挤度退潮策略"
SOURCE_FACTOR_ID = "DUOYU002897"
CATEGORY = "拥挤度退潮"
STYLE = "动量"
OPERATOR_ID = "拥挤度退潮_v1"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = -_zscore(attention, 6) * weakening - 0.25 * VARIANT_WEIGHT * _zscore(turnover, 6)
    score = _risk_scale(_cs_rank(raw), panel, 9)
    # instance: 拥挤度退潮_v1 | style: 动量 | seed: 20256210
