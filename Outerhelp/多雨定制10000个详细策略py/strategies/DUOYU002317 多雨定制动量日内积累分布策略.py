...
STRATEGY_ID = "DUOYU002317"
STRATEGY_NAME = "多雨定制动量日内积累分布策略"
SOURCE_FACTOR_ID = "DUOYU002317"
CATEGORY = "日内积累分布"
STYLE = "动量"
OPERATOR_ID = "日内积累分布_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    """计算本策略的原始横截面分数。"""
    raw = _close_location(panel) + 0.42 * VARIANT_WEIGHT * _vwap_support(panel, 5) + 0.17 * VARIANT_WEIGHT * _amount_z(panel, 5)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 日内积累分布_v2 | style: 动量 | seed: 20253211
