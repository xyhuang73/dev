...
STRATEGY_ID = "DUOYU004409"
STRATEGY_NAME = "多雨定制反转多维流动性承载策略"
SOURCE_FACTOR_ID = "DUOYU004409"
CATEGORY = "多维流动性承载"
STYLE = "反转"
OPERATOR_ID = "多维流动性承载_v3"
MARKET_SCOPE = "流动性较好"
HORIZON_DAYS = 7
FAST_WINDOW = 9
SLOW_WINDOW = 24
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.45 * VARIANT_WEIGHT * _amount_z(panel, 27) + 0.35 * VARIANT_WEIGHT * _zscore(turnover, 9) - _zscore(spread, 9).abs()
    score = _cs_rank(raw)
    # instance: 多维流动性承载_v3 | style: 反转 | seed: 20263412
