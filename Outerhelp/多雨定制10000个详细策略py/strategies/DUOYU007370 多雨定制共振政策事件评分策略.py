...
STRATEGY_ID = "DUOYU007370"
STRATEGY_NAME = "多雨定制共振政策事件评分策略"
SOURCE_FACTOR_ID = "DUOYU007370"
CATEGORY = "政策事件评分"
STYLE = "共振"
OPERATOR_ID = "政策事件评分_v1"
MARKET_SCOPE = "行业/主题"
HORIZON_DAYS = 7
FAST_WINDOW = 7
SLOW_WINDOW = 28
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = _zscore(policy, 7) * _event_proximity(distance, 7) + 0.22 * VARIANT_WEIGHT * _amount_z(panel, 7)
    score = _risk_scale(_cs_rank(raw), panel, 7)
    # instance: 政策事件评分_v1 | style: 共振 | seed: 20281510
