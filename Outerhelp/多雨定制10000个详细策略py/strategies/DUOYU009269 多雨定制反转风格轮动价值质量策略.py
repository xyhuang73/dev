...
STRATEGY_ID = "DUOYU009269"
STRATEGY_NAME = "多雨定制反转风格轮动价值质量策略"
SOURCE_FACTOR_ID = "DUOYU009269"
CATEGORY = "风格轮动价值质量"
STYLE = "反转"
OPERATOR_ID = "风格轮动价值质量_v6"
MARKET_SCOPE = "风格/宽基"
HORIZON_DAYS = 11
FAST_WINDOW = 7
SLOW_WINDOW = 19
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = -0.26 * VARIANT_WEIGHT * _zscore(valuation, 21) + 0.22 * VARIANT_WEIGHT * _zscore(quality, 21) + 0.25 * VARIANT_WEIGHT * _zscore(dividend, 21) + _ret(close, 7)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 风格轮动价值质量_v6 | style: 反转 | seed: 20294415
