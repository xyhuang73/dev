...
STRATEGY_ID = "DUOYU001796"
STRATEGY_NAME = "多雨定制持有横截面动量差异策略"
SOURCE_FACTOR_ID = "DUOYU001796"
CATEGORY = "横截面动量差异"
STYLE = "持有"
OPERATOR_ID = "横截面动量差异_v6"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.3 * VARIANT_WEIGHT * _zscore(momentum_diff, 5) + _ret(close, 22)
    score = _risk_scale(_cs_rank(raw), panel, 7)
    # instance: 横截面动量差异_v6 | style: 持有 | seed: 20250115
