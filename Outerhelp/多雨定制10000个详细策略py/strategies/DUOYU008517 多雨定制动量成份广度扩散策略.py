...
STRATEGY_ID = "DUOYU008517"
STRATEGY_NAME = "多雨定制动量成份广度扩散策略"
SOURCE_FACTOR_ID = "DUOYU008517"
CATEGORY = "成份广度扩散"
STYLE = "动量"
OPERATOR_ID = "成份广度扩散_v2"
MARKET_SCOPE = "宽基/行业"
HORIZON_DAYS = 12
FAST_WINDOW = 16
SLOW_WINDOW = 22
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.47 * VARIANT_WEIGHT * _zscore(up_ratio, 14) + 0.41 * VARIANT_WEIGHT * _zscore(new_high_ratio, 26) - _zscore(dispersion, 26).abs()
    score = _risk_scale(_cs_rank(raw), panel, 11)
    # instance: 成份广度扩散_v2 | style: 动量 | seed: 20290211
