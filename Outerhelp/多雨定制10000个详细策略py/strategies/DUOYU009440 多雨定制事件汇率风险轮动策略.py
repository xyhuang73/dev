...
STRATEGY_ID = "DUOYU009440"
STRATEGY_NAME = "多雨定制事件汇率风险轮动策略"
SOURCE_FACTOR_ID = "DUOYU009440"
CATEGORY = "汇率风险轮动"
STYLE = "事件"
OPERATOR_ID = "汇率风险轮动_v2"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    currency_impact = _ret(close, 5) - _ret(nav, 5)
    raw = 0.33 * VARIANT_WEIGHT * _zscore(currency_impact, 5) + _ret(nav, 27)
    score = _risk_scale(_cs_rank(raw), panel, 13)
    # instance: 汇率风险轮动_v2 | style: 事件 | seed: 20297511
