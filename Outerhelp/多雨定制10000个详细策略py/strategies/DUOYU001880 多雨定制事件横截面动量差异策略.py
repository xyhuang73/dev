...
STRATEGY_ID = "DUOYU001880"
STRATEGY_NAME = "多雨定制事件横截面动量差异策略"
SOURCE_FACTOR_ID = "DUOYU001880"
CATEGORY = "横截面动量差异"
STYLE = "事件"
OPERATOR_ID = "横截面动量差异_v10"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.37 * VARIANT_WEIGHT * _zscore(momentum_diff, 9) + _ret(close, 26)
    score = _risk_scale(_cs_rank(raw), panel, 11)
    # instance: 横截面动量差异_v10 | style: 事件 | seed: 20250519
