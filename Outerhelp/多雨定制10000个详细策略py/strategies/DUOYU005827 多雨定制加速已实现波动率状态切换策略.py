...
STRATEGY_ID = "DUOYU005827"
STRATEGY_NAME = "多雨定制加速已实现波动率状态切换策略"
SOURCE_FACTOR_ID = "DUOYU005827"
CATEGORY = "已实现波动率状态切换"
STYLE = "加速"
OPERATOR_ID = "已实现波动率状态切换_v4"
...
"""
DUOYU005827 - 多雨定制加速已实现波动率状态切换策略
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    """计算本策略的原始横截面分数。"""
    close = _field(panel, "close")
    vol_regime = _vol_regime(close, 6, 25)
    trend_term = _ret(close, 25) * _sigmoid_gate(vol_regime, 0, 3)
    ...
    # instance: 已实现波动率状态切换_v4 | style: 加速 | seed: 20271213
