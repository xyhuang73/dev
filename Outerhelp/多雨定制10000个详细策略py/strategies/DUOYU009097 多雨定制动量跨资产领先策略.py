...
STRATEGY_ID = "DUOYU009097"
STRATEGY_NAME = "多雨定制动量跨资产领先策略"
SOURCE_FACTOR_ID = "DUOYU009097"
CATEGORY = "跨资产领先"
STYLE = "动量"
OPERATOR_ID = "跨资产领先_v3"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = lead + 0.4 * VARIANT_WEIGHT * _ret(close, 9) + 0.27 * VARIANT_WEIGHT * _zscore(appetite, 15)
    score = _risk_scale(_cs_rank(raw), panel, 12)
    # instance: 跨资产领先_v3 | style: 动量 | seed: 20294212
