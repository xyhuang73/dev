...
STRATEGY_ID = "DUOYU009516"
STRATEGY_NAME = "多雨定制持有汇率风险轮动策略"
SOURCE_FACTOR_ID = "DUOYU009516"
CATEGORY = "汇率风险轮动"
STYLE = "持有"
OPERATOR_ID = "汇率风险轮动_v6"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.29 * VARIANT_WEIGHT * _zscore(currency_impact, 10) + _ret(nav, 26)
    score = _risk_scale(_cs_rank(raw), panel, 7)
    # instance: 汇率风险轮动_v6 | style: 持有 | seed: 20297115
