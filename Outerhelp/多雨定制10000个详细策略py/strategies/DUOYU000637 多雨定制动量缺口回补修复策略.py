...
STRATEGY_ID = "DUOYU000637"
STRATEGY_NAME = "多雨定制动量缺口回补修复策略"
SOURCE_FACTOR_ID = "DUOYU000637"
CATEGORY = "缺口回补修复"
STYLE = "动量"
OPERATOR_ID = "缺口回补修复_v10"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    gap_fill = -_zscore(overnight_gap, 8)
    trend = _ret(close, 20)
    raw = gap_fill * _sigmoid_gate(trend, 0, 3) + 0.11 * VARIANT_WEIGHT * _amount_z(panel, 8)
    score = _risk_scale(_cs_rank(raw), panel, 13)
    # instance: 缺口回补修复_v10 | style: 动量 | seed: 20244219
