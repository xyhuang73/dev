...
STRATEGY_ID = "DUOYU002736"
STRATEGY_NAME = "多雨定制持有份额扩张吸收策略"
SOURCE_FACTOR_ID = "DUOYU002736"
CATEGORY = "份额扩张吸收"
STYLE = "持有"
OPERATOR_ID = "份额扩张吸收_v3"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    resilience = _ret(close, 6) - _downside_vol(close, 6)
    raw = _diff(fund_share, 18) * resilience + 0.18 * VARIANT_WEIGHT * _amount_z(panel, 18)
    score = _risk_scale(_cs_rank(raw), panel, 17)
    # instance: 份额扩张吸收_v3 | style: 持有 | seed: 20255112
