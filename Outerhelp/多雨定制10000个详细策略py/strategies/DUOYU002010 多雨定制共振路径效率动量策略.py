...
STRATEGY_ID = "DUOYU002010"
STRATEGY_NAME = "多雨定制共振路径效率动量策略"
SOURCE_FACTOR_ID = "DUOYU002010"
CATEGORY = "路径效率动量"
STYLE = "共振"
OPERATOR_ID = "路径效率动量_v7"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    """计算本策略的原始横截面分数。"""
    close = _field(panel, "close")
    eff = _rolling_efficiency_ratio(close, 17)
    raw = 0.51 * VARIANT_WEIGHT * _zscore(eff, 8) + _ret(close, 17)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 路径效率动量_v7 | style: 共振 | seed: 20250516
