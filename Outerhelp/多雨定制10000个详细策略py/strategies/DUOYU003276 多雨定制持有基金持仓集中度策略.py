...
STRATEGY_ID = "DUOYU003276"
STRATEGY_NAME = "多雨定制持有基金持仓集中度策略"
SOURCE_FACTOR_ID = "DUOYU003276"
CATEGORY = "基金持仓集中度"
STYLE = "持有"
OPERATOR_ID = "基金持仓集中度_v10"
MARKET_SCOPE = "宽基/行业"
HORIZON_DAYS = 12
FAST_WINDOW = 8
SLOW_WINDOW = 33
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.33 * VARIANT_WEIGHT * _zscore(inst_holding, 22) + 0.43 * VARIANT_WEIGHT * divergence - 0.24 * VARIANT_WEIGHT * _concentration_risk(top10_conc, 22)
    score = _risk_scale(_cs_rank(raw), panel, 19)
    # instance: 基金持仓集中度_v10 | style: 持有 | seed: 20257119
