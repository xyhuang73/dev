...
STRATEGY_ID = "DUOYU000369"
STRATEGY_NAME = "多雨定制反转多时间框架动量策略"
SOURCE_FACTOR_ID = "DUOYU000369"
CATEGORY = "多时间框架动量"
STYLE = "反转"
OPERATOR_ID = "多时间框架动量_v8"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    ret_m = _ret(close, 17)
    ret_l = _ret(close, 20)
    raw = 0.36 * VARIANT_WEIGHT * ret_s + 0.35 * VARIANT_WEIGHT * ret_m + 0.27 * VARIANT_WEIGHT * ret_l - 0.3 * _downside_vol(close, 20)
    score = _risk_scale(_cs_rank(raw), panel, 13)
    # instance: 多时间框架动量_v8 | style: 反转 | seed: 20242417
