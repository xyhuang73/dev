...
STRATEGY_ID = "DUOYU004497"
STRATEGY_NAME = "多雨定制动量多维流动性承载策略"
SOURCE_FACTOR_ID = "DUOYU004497"
CATEGORY = "多维流动性承载"
STYLE = "动量"
OPERATOR_ID = "多维流动性承载_v7"
MARKET_SCOPE = "流动性较好"
HORIZON_DAYS = 20
FAST_WINDOW = 9
SLOW_WINDOW = 22
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.42 * VARIANT_WEIGHT * _amount_z(panel, 26) + 0.33 * VARIANT_WEIGHT * _zscore(turnover, 8) - _zscore(spread, 8).abs()
    score = _cs_rank(raw)
    # instance: 多维流动性承载_v7 | style: 动量 | seed: 20264216
