...
STRATEGY_ID = "DUOYU001420"
STRATEGY_NAME = "多雨定制事件相对强弱动量策略"
SOURCE_FACTOR_ID = "DUOYU001420"
CATEGORY = "相对强弱动量"
STYLE = "事件"
OPERATOR_ID = "相对强弱动量_v7"
MARKET_SCOPE = "宽基/行业"
HORIZON_DAYS = 14
FAST_WINDOW = 8
SLOW_WINDOW = 12
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = _ret(close, 14) - _ret(index_close, 14) + 0.38 * VARIANT_WEIGHT * _zscore(breadth, 8)
    score = _risk_scale(_cs_rank(raw), panel, 13)
    # instance: 相对强弱动量_v7 | style: 事件 | seed: 20248516
