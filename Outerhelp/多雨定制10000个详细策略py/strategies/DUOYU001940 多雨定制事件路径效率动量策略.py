...
STRATEGY_ID = "DUOYU001940"
STRATEGY_NAME = "多雨定制事件路径效率动量策略"
SOURCE_FACTOR_ID = "DUOYU001940"
CATEGORY = "路径效率动量"
STYLE = "事件"
OPERATOR_ID = "路径效率动量_v3"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = 0.4 * VARIANT_WEIGHT * _zscore(eff, 13) + _ret(close, 28)
    score = _risk_scale(_cs_rank(raw), panel, 6)
    # instance: 路径效率动量_v3 | style: 事件 | seed: 20251512
