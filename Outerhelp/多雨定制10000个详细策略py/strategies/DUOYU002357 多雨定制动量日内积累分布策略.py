...
STRATEGY_ID = "DUOYU002357"
STRATEGY_NAME = "多雨定制动量日内积累分布策略"
SOURCE_FACTOR_ID = "DUOYU002357"
CATEGORY = "日内积累分布"
STYLE = "动量"
OPERATOR_ID = "日内积累分布_v4"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    """计算本策略的原始横截面分数。"""
    raw = _close_location(panel) + 0.27 * VARIANT_WEIGHT * _vwap_support(panel, 7) + 0.21 * VARIANT_WEIGHT * _amount_z(panel, 7)
    score = _risk_scale(_cs_rank(raw), panel, 7)
    # instance: 日内积累分布_v4 | style: 动量 | seed: 20253213
