...
STRATEGY_ID = "DUOYU002389"
STRATEGY_NAME = "多雨定制反转日内积累分布策略"
SOURCE_FACTOR_ID = "DUOYU002389"
CATEGORY = "日内积累分布"
STYLE = "反转"
OPERATOR_ID = "日内积累分布_v6"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    """计算本策略的原始横截面分数。"""
    raw = _close_location(panel) + 0.3 * VARIANT_WEIGHT * _vwap_support(panel, 5) + 0.23 * VARIANT_WEIGHT * _amount_z(panel, 5)
    score = _risk_scale(_cs_rank(raw), panel, 12)
    # instance: 日内积累分布_v6 | style: 反转 | seed: 20252415
