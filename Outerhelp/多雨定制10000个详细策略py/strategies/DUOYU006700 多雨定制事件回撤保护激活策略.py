...
STRATEGY_ID = "DUOYU006700"
STRATEGY_NAME = "多雨定制事件回撤保护激活策略"
SOURCE_FACTOR_ID = "DUOYU006700"
CATEGORY = "回撤保护激活"
STYLE = "事件"
OPERATOR_ID = "回撤保护激活_v7"
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    dd_guard = _max_dd_guard(drawdown, -0.17)
    raw = -_zscore(drawdown, 28) * dd_guard + 0.36 * VARIANT_WEIGHT * _zscore(net_flow, 6) + _repair_slope(close, 6)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 回撤保护激活_v7 | style: 事件 | seed: 20277516
