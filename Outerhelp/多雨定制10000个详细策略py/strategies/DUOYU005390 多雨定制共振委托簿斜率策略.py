...
STRATEGY_ID = "DUOYU005390"
STRATEGY_NAME = "多雨定制共振委托簿斜率策略"
SOURCE_FACTOR_ID = "DUOYU005390"
CATEGORY = "委托簿斜率"
STYLE = "共振"
OPERATOR_ID = "委托簿斜率_v7"
MARKET_SCOPE = "流动性较好"
HORIZON_DAYS = 10
FAST_WINDOW = 7
SLOW_WINDOW = 24
...
def _compute_raw_score(panel: pd.DataFrame) -> pd.Series:
    ...
    raw = -0.4 * VARIANT_WEIGHT * _zscore(book_slope, 7) + _ret(close, 24)
    score = _risk_scale(_cs_rank(raw), panel, 10)
    # instance: 委托簿斜率_v7 | style: 共振 | seed: 20268516
